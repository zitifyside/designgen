...
export const HELP_ITEMS: HelpItem[] = [
  // ── 시작하기 ────────────────────────────────────────────────
  {
    ...
    answer: [
      "[새 프로젝트]에서 만들려는 서비스를 문장으로 적는 것이 시작입니다. 화면을 고르거나 색을 지정하지 않아도 됩니다 — 요건 문장에서 대표 화면을 추론합니다.",
      "생성이 끝나면 컨셉이 여러 개 나옵니다. 마음에 드는 컨셉을 하나 확정하면 그때부터 토큰을 다듬고 화면을 추가할 수 있습니다.",
  ...
  },
  {
    ...
    answer: [
      "누가 무엇을 하는 서비스인지, 그리고 그 화면에서 가장 중요한 정보가 무엇인지를 적어 주세요. '깔끔하게'·'모던하게' 같은 형용사보다 '지표 카드와 매출 차트가 먼저 보여야 한다'가 훨씬 잘 반영됩니다.",
  ...
  // ── 생성과 시안 ─────────────────────────────────────────────
  {
    ...
    answer: [
      ...
      "시안은 **같은 화면을 다르게 배치한 결과**입니다. 서로 다른 화면이 아니라, 하나의 대표 화면을 몇 가지 구조로 바꿔 본 것입니다.",
      "즉 '컨셉 3 × 시안 5' 는 서로 다른 화면 15개가 아니라, 방향 3가지 각각에 대해 같은 화면의 배치 5가지를 본다는 뜻입니다.",
    ],
    keywords: ["컨셉", "시안", "variant", "차이", "구조", "레이아웃"],
  },
  {
    id: "add-screen",
    category: "생성과 시안",
    question: "다른 화면(로그인·설정 등)도 만들고 싶습니다.",
    answer: [
      "컨셉을 확정한 뒤 작업 화면에서 [화면 추가]를 사용하세요. 확정된 디자인 시스템을 그대로 쓰면서 새 화면의 배치만 만듭니다.",
      "시안 수를 늘리는 것으로는 다른 화면이 나오지 않습니다. 시안은 같은 화면의 변형이기 때문입니다.",
      "화면 추가는 토큰을 다시 만들지 않으므로 처음 생성보다 빠르고, 결과가 기존 화면과 같은 시스템 위에 놓입니다.",
    ],
    keywords: ["화면 추가", "로그인 화면", "다른 화면", "스크린"],
  },
  {
    id: "concept-lock",
    category: "생성과 시안",
